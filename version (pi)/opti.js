    ...
    (function () {
        ...
        ||(parseInt(window.localStorage.getItem("r_jrssi"))) != (parseInt(window.localStorage.getItem("o_r_jrssi")))){
            ...
            localStorage.setItem("o_r_jrssi",window.localStorage.getItem("r_jrssi"));
             ...
             alerte=parseInt(window.localStorage.getItem("c_rssi"));
             delta_alerte= parseInt(window.localStorage.getItem("r_rssi"));
             warn= parseInt(window.localStorage.getItem("c_jrssi"));
             delta_warn=parseInt(window.localStorage.getItem("r_jrssi"));
        }
        else{
...
document.querySelector('#set_Param'). onclick=function() {
  ...
  document.querySelector('#i_réglage'). onclick=function() {
    if( $('#sect_1').css('display')=='none'){
        $('#sect_1').css("display", "block");
        $('#sect_2').css("display", "none");
    }
    else{
        $('#sect_1').css("display", "none");
        $('#sect_2').css("display", "block");
    }
